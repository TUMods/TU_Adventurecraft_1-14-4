...
public class ItemList {
    ...
    public static Item knife_flint;
    public static Item hoshick_flint;

    // ItemBlock
    public static Item block_copper;
    public static Item ore_overworld_copper;
    public static Item ore_overworld_manganese;
    public static Item ore_overworld_silver;
